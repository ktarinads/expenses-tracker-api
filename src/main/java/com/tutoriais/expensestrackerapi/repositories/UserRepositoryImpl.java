...
public class UserRepositoryImpl implements UserRepository{
    ...
    @Override
    public Integer create(String firsName, String lastName, String email, String password) throws EtAuthException {
        String hashedPassword = BCrypt.hashpw(password, BCrypt.gensalt(10));
           ...
           try {
               ...
               throw new EtAuthException("Invalid details. Failed to create documents.");
           }
    }
    ...
    public User findByEmailAndPassword(String email, String password) throws EtAuthException {
        try{
            ...
            if (!BCrypt.checkpw(password,user.getPass()))
                throw new EtAuthException("Invalid email/pass");
            return user;
